...
! ITL Test Source File:      digital/u1_c1_connect_d
! Test Name:                 U1_C1
! VCL created for chain:     U1_C1_U5_R3
! Date: Thu Sep 30 16:27:37 2021
...
assign N0000 to nodes "QSFP_MOD_ABS<0>" ! Pin(s) 32
assign N0010 to nodes "QSFP_MOD_ABS<10>" ! Pin(s) 96
assign N0011 to nodes "QSFP_MOD_ABS<11>" ! Pin(s) 112
assign N0012 to nodes "QSFP_MOD_ABS<12>" ! Pin(s) 122
assign N0013 to nodes "QSFP_MOD_ABS<13>" ! Pin(s) 133
assign N0001 to nodes "QSFP_MOD_ABS<1>" ! Pin(s) 23
assign N0002 to nodes "QSFP_MOD_ABS<2>" ! Pin(s) 21
assign N0003 to nodes "QSFP_MOD_ABS<3>" ! Pin(s) 5
assign N0004 to nodes "QSFP_MOD_ABS<4>" ! Pin(s) 65
assign N0005 to nodes "QSFP_MOD_ABS<5>" ! Pin(s) 52
assign N0006 to nodes "QSFP_MOD_ABS<6>" ! Pin(s) 42
assign N0007 to nodes "QSFP_MOD_ABS<7>" ! Pin(s) 76
assign N0008 to nodes "QSFP_MOD_ABS<8>" ! Pin(s) 78
assign N0009 to nodes "QSFP_MOD_ABS<9>" ! Pin(s) 94
...
!   21   9    U1_C1.5    QSFP_MOD_ABS<3> 'LH'
!   41  29    U1_C1.21   QSFP_MOD_ABS<2> 'LH'
!   45  33    U1_C1.23   QSFP_MOD_ABS<1> 'LH'
!   57  45    U1_C1.32   QSFP_MOD_ABS<0> 'LH'
!   73  61    U1_C1.42   QSFP_MOD_ABS<6> 'LH'
!   89  77    U1_C1.52   QSFP_MOD_ABS<5> 'LH'
!  109  97    U1_C1.65   QSFP_MOD_ABS<4> 'LH'
!  127 115    U1_C1.76   QSFP_MOD_ABS<7> 'LH'
!  131 119    U1_C1.78   QSFP_MOD_ABS<8> 'LH'
!  151 139    U1_C1.94   QSFP_MOD_ABS<9> 'LH'
!  155 143    U1_C1.96   QSFP_MOD_ABS<10>'LH'
!  179 167    U1_C1.112  QSFP_MOD_ABS<11>'LH'
!  195 183    U1_C1.122  QSFP_MOD_ABS<12>'LH'
!  207 195    U1_C1.133  QSFP_MOD_ABS<13>'LH'

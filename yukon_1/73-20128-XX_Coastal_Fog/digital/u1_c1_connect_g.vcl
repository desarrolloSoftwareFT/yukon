...
! ITL Test Source File:      digital/u1_c1_connect_g
! Test Name:                 U1_C1
! VCL created for chain:     U1_C1_U5_R3
! Date: Thu Sep 30 16:31:33 2021
...
! Boundary-Scan system pins tested: 11  (Not Including TAP Pins, Compliance
...
assign N0007 to nodes "QSFP_LPMODE<10>" ! Pin(s) 100
assign N0008 to nodes "QSFP_LPMODE<11>" ! Pin(s) 117
assign N0009 to nodes "QSFP_LPMODE<12>" ! Pin(s) 128
assign N0010 to nodes "QSFP_LPMODE<13>" ! Pin(s) 139
...
assign N0005 to nodes "QSFP_LPMODE<8>" ! Pin(s) 86
assign N0006 to nodes "QSFP_LPMODE<9>" ! Pin(s) 92
...
bidirectional   N0000, N0007, N0008, N0009, N0010, N0001, N0002, N0003
bidirectional   N0004, N0005, N0006
 
inputs          D0004, D0000, D0001, D0002, D0003, D0005, D0006, D0007
inputs          D0008
 
use cards hybrid         on N0000, N0007, N0008, N0009, N0010, N0001, N0002, N0003
use cards hybrid         on N0004, N0005, N0006
...
!Column-to-Node Map, Nodes 1 to 16
!SJJJJQQQQQQQQQQQ!
!RTTTTSSSSSSSSSSS!
!TAAAAFFFFFFFFFFF!
!_GGGGPPPPPPPPPPP!
...
"01ZX0XXXXXXXXXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXX"
"10ZX1XXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
use pcf order Parallel
...
use pcf order Parallel
"00ZX100000000000"
"10ZX100000000000"!Shift-DR
"10ZX1Z0000000000"!Disable drivers sequentially. 
"10ZX1ZZ000000000"
"10ZX1ZZZ00000000"
"10ZX1ZZZZ0000000"
"10ZX1ZZZZZ000000"
...
use pcf order Parallel
"00ZX111111111111"
"10ZX111111111111"!Shift-DR
"10ZX1Z1111111111"!Disable drivers sequentially. 
"10ZX1ZZ111111111"
"10ZX1ZZZ11111111"
"10ZX1ZZZZ1111111"
"10ZX1ZZZZZ111111"
...
"01ZX1"
"11ZX1"!Select-IR-Scan Vector 2800
use pcf order Parallel
"01ZX1XXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Test-Logic-Reset
...
end unit ! Connect Test Vector 2804
! Vectors with TDI High:    1952,   1.9 milliseconds
! Vectors with TDI Low:       88,  88.0 microseconds
! Total Vectors :           2804,   2.8 milliseconds

! Connect Test Dictionary
! Frame Size 220
! FrCell DevCell Dev.Pin Node             Signature
!   25  13    U1_C1.9    QSFP_LPMODE<3>  'LH'
!   29  17    U1_C1.11   QSFP_LPMODE<2>  'LH'
!   49  37    U1_C1.25   QSFP_LPMODE<1>  'LH'
!   61  49    U1_C1.34   QSFP_LPMODE<0>  'LH'
!   97  85    U1_C1.57   QSFP_LPMODE<4>  'LH'
!  143 131    U1_C1.86   QSFP_LPMODE<8>  'LH'
!  147 135    U1_C1.92   QSFP_LPMODE<9>  'LH'
!  163 151    U1_C1.100  QSFP_LPMODE<10> 'LH'
!  187 175    U1_C1.117  QSFP_LPMODE<11> 'LH'
!  203 191    U1_C1.128  QSFP_LPMODE<12> 'LH'
!  211 199    U1_C1.139  QSFP_LPMODE<13> 'LH'

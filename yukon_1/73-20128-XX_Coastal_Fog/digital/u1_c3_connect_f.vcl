...
! ITL Test Source File:      digital/u1_c3_connect_f
! Test Name:                 U1_C3
! VCL created for chain:     U1_C1_U5_R3
! Date: Thu Sep 30 17:12:24 2021
...
! Boundary-Scan system pins tested: 4  (Not Including TAP Pins, Compliance
...
assign N0000 to nodes "QSFP_LPMODE<28>" ! Pin(s) 34
assign N0001 to nodes "QSFP_LPMODE<29>" ! Pin(s) 25
assign N0002 to nodes "QSFP_LPMODE<30>" ! Pin(s) 11
assign N0003 to nodes "QSFP_LPMODE<31>" ! Pin(s) 9
...
bidirectional   N0000, N0001, N0002, N0003
 
inputs          D0004, D0000, D0001, D0002, D0003, D0005, D0006, D0007
inputs          D0008
 
use cards hybrid         on N0000, N0001, N0002, N0003
...
"01ZX0XXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
"00ZX10000"
"10ZX10000"!Shift-DR
"10ZX1Z000"!Disable drivers sequentially. 
"10ZX1ZZ00"
"10ZX1ZZZ0"
"10ZX1ZZZZ"
...
use pcf order Parallel
"00ZX11111"
"10ZX11111"!Shift-DR Vector 2325
"10ZX1Z111"!Disable drivers sequentially. 
"10ZX1ZZ11"
"10ZX1ZZZ1"
"10ZX1ZZZZ"
! Load 4 Sentinel bits into chain registers.

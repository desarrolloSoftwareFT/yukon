...
! ITL Test Source File:      digital/u1_c1_connect
! Test Name:                 U1_C1
! VCL created for chain:     U1_C1_U5_R3
! Date: Sat Sep 18 13:52:52 2021
...
! Boundary-Scan system pins tested: 15  (Not Including TAP Pins, Compliance
! Enable pins, Disable pins, Hold pins and pins on 'TAP_Only' devices.)
 
scan connect ! Test device U1_C1
...
assign N0001 to nodes "QSFP_RST_L<0>" ! Pin(s) 33
assign N0011 to nodes "QSFP_RST_L<10>" ! Pin(s) 95
assign N0012 to nodes "QSFP_RST_L<11>" ! Pin(s) 111
assign N0013 to nodes "QSFP_RST_L<12>" ! Pin(s) 121
assign N0014 to nodes "QSFP_RST_L<13>" ! Pin(s) 132
assign N0002 to nodes "QSFP_RST_L<1>" ! Pin(s) 24
assign N0003 to nodes "QSFP_RST_L<2>" ! Pin(s) 22
assign N0004 to nodes "QSFP_RST_L<3>" ! Pin(s) 6
assign N0005 to nodes "QSFP_RST_L<4>" ! Pin(s) 67
assign N0006 to nodes "QSFP_RST_L<5>" ! Pin(s) 54
assign N0007 to nodes "QSFP_RST_L<6>" ! Pin(s) 43
assign N0008 to nodes "QSFP_RST_L<7>" ! Pin(s) 75
assign N0009 to nodes "QSFP_RST_L<8>" ! Pin(s) 77
assign N0010 to nodes "QSFP_RST_L<9>" ! Pin(s) 93
...
outputs         N0001
bidirectional   N0000, N0011, N0012, N0013, N0014, N0002, N0003, N0004
bidirectional   N0005, N0006, N0007, N0008, N0009, N0010
 
inputs          D0000, D0001, D0002, D0003, D0004
 
use cards hybrid         on N0000, N0001, N0011, N0012, N0013, N0014, N0002, N0003
use cards hybrid         on N0004, N0005, N0006, N0007, N0008, N0009, N0010
...
pcf order Parallel is N0011, N0012, N0013, N0014
 
pcf order Disable_1 is  D0000, D0001, D0002, D0003, D0004
 

!Column-to-Node Map, Nodes 1 to 20
!SJJJJCQQQQQQQQQQQQQQ!
!RTTTTPSSSSSSSSSSSSSS!
!TAAAALFFFFFFFFFFFFFF!
!_GGGGDPPPPPPPPPPPPPP!
!J____1______________!
!TTTTT_RRRRRRRRRRRRRR!
!AMDDRFSSSSSSSSSSSSSS!
!GSIOSPTTTTTTTTTTTTTT!
!____TG______________!
!THCH_ALLLLLLLLLLLLLL!
!CDPDL_<<<<<<<<<<<<<<!
!KRLR_D01234567891111!
!__D_HA>>>>>>>>>>0123!
!H313DT          >>>>!
!DV VRA              !
!R3 3_               !
...
"01ZX0XXXXXXXXXXXXXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
use pcf order Parallel
...
message ""
! Set up Chain for Connect Test of device U1_C1
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXX"! Vector 1050
"10ZX1XXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
...
"11ZX1"!Exit1-DR
use pcf order Parallel
"01ZX1XXXXXXXXXXXXXXX"! Vector 1675
use pcf order Scan
"11ZX1"!Update-DR
end pcf
message ""
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX10X0000000000000"
"10ZX10X0000000000000"!Shift-DR
"10ZX1ZX0000000000000"!Disable drivers sequentially. 
"10ZX1ZXZ000000000000"
"10ZX1ZXZZ00000000000"
"10ZX1ZXZZZ0000000000"
"10ZX1ZXZZZZ000000000"
"10ZX1ZXZZZZZ00000000"
"10ZX1ZXZZZZZZ0000000"
"10ZX1ZXZZZZZZZ000000"
"10ZX1ZXZZZZZZZZ00000"
"10ZX1ZXZZZZZZZZZ0000"
"10ZX1ZXZZZZZZZZZZ000"
"10ZX1ZXZZZZZZZZZZZ00"
"10ZX1ZXZZZZZZZZZZZZ0"! Vector 1875
"10ZX1ZXZZZZZZZZZZZZZ"
...
pcf
use pcf order Parallel
"01ZX1XXXXXXXXXXXXXXX"! Vector 2325
use pcf order Scan
"11ZX1"!Update-DR
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX11X1111111111111"
"10ZX11X1111111111111"!Shift-DR
"10ZX1ZX1111111111111"!Disable drivers sequentially. 
"10ZX1ZXZ111111111111"
"10ZX1ZXZZ11111111111"
"10ZX1ZXZZZ1111111111"
"10ZX1ZXZZZZ111111111"
"10ZX1ZXZZZZZ11111111"
"10ZX1ZXZZZZZZ1111111"
"10ZX1ZXZZZZZZZ111111"
"10ZX1ZXZZZZZZZZ11111"
"10ZX1ZXZZZZZZZZZ1111"
"10ZX1ZXZZZZZZZZZZ111"
"10ZX1ZXZZZZZZZZZZZ11"
"10ZX1ZXZZZZZZZZZZZZ1"
"10ZX1ZXZZZZZZZZZZZZZ"
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U5_R3.
end pcf
...
pcf
use pcf order Parallel
"000L1XXXXXXXXXXXXXXX"!0+0 Vector 2350
use pcf order Scan
"100X1"
! Unloading device U5_R2 register BYPASS[1] (for BYPASS).
"001L1"!1+0
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1ZXZZZZZZZZZZZZZ"
"10ZX1ZXZZZZZZZZZZZZZ"!Shift-DR
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U5_R3.
end pcf
compress
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1ZLZZZZZZZZZZZZZ"
"10ZX1ZLZZZZZZZZZZZZZ"!Shift-DR
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U5_R3.
end pcf
compress
...
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
"00ZX1HHHHHHHHHHHHHHH"
"10ZX1XXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U1_C1
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXXXXXXX"! Vector 3725
use pcf order Scan
"11ZX1"!Test-Logic-Reset
"01ZX1"
"11ZX1"!Test-Logic-Reset
end pcf
end unit ! Connect Test Vector 3728
! Vectors with TDI High:    2394,   2.3 milliseconds
! Vectors with TDI Low:      186, 186.0 microseconds
! Total Vectors :           3728,   3.7 milliseconds

! Connect Test Dictionary
! Frame Size 220
! FrCell DevCell Dev.Pin Node             Signature
!   23  11    U1_C1.6    QSFP_RST_L<3>   'LHXX'
!   43  31    U1_C1.22   QSFP_RST_L<2>   'LHXX'
!   47  35    U1_C1.24   QSFP_RST_L<1>   'LHXX'
!   75  63    U1_C1.43   QSFP_RST_L<6>   'LHXX'
!   91  79    U1_C1.54   QSFP_RST_L<5>   'LHXX'
!  105  93    U1_C1.61   CPLD1_FPGA_DATA 'LHXX'
!  111  99    U1_C1.67   QSFP_RST_L<4>   'LHXX'
!  125 113    U1_C1.75   QSFP_RST_L<7>   'LHXX'
!  129 117    U1_C1.77   QSFP_RST_L<8>   'LHXX'
!  149 137    U1_C1.93   QSFP_RST_L<9>   'LHXX'
!  153 141    U1_C1.95   QSFP_RST_L<10>  'LHXX'
!  177 165    U1_C1.111  QSFP_RST_L<11>  'LHXX'
!  193 181    U1_C1.121  QSFP_RST_L<12>  'LHXX'
!  205 193    U1_C1.132  QSFP_RST_L<13>  'LHXX'

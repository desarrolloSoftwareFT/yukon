...
! ITL Test Source File:      digital/u1_c1_connect_c
! Test Name:                 U1_C1
! VCL created for chain:     U1_C1_U5_R3
! Date: Sat Sep 18 14:03:34 2021
...
assign N0000 to nodes "QSFP_LPMODE<0>" ! Pin(s) 34
assign N0010 to nodes "QSFP_LPMODE<10>" ! Pin(s) 100
assign N0011 to nodes "QSFP_LPMODE<11>" ! Pin(s) 117
assign N0012 to nodes "QSFP_LPMODE<12>" ! Pin(s) 128
assign N0013 to nodes "QSFP_LPMODE<13>" ! Pin(s) 139
assign N0001 to nodes "QSFP_LPMODE<1>" ! Pin(s) 25
assign N0002 to nodes "QSFP_LPMODE<2>" ! Pin(s) 11
assign N0003 to nodes "QSFP_LPMODE<3>" ! Pin(s) 9
assign N0004 to nodes "QSFP_LPMODE<4>" ! Pin(s) 57
assign N0005 to nodes "QSFP_LPMODE<5>" ! Pin(s) 49
assign N0006 to nodes "QSFP_LPMODE<6>" ! Pin(s) 38
assign N0007 to nodes "QSFP_LPMODE<7>" ! Pin(s) 74
assign N0008 to nodes "QSFP_LPMODE<8>" ! Pin(s) 86
assign N0009 to nodes "QSFP_LPMODE<9>" ! Pin(s) 92
...
bidirectional   N0000, N0010, N0011, N0012, N0013, N0001, N0002, N0003
bidirectional   N0004, N0005, N0006, N0007, N0008, N0009
 
inputs          D0000, D0001, D0002, D0003, D0004
 
use cards hybrid         on N0000, N0010, N0011, N0012, N0013, N0001, N0002, N0003
use cards hybrid         on N0004, N0005, N0006, N0007, N0008, N0009
...
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXXXXXX"! Vector 3725
use pcf order Scan
"11ZX1"!Test-Logic-Reset
"01ZX1"
"11ZX1"!Test-Logic-Reset
...
!   25  13    U1_C1.9    QSFP_LPMODE<3>  'LHXX'
!   29  17    U1_C1.11   QSFP_LPMODE<2>  'LHXX'
!   49  37    U1_C1.25   QSFP_LPMODE<1>  'LHXX'
!   61  49    U1_C1.34   QSFP_LPMODE<0>  'LHXX'
!   65  53    U1_C1.38   QSFP_LPMODE<6>  'LHXX'
!   85  73    U1_C1.49   QSFP_LPMODE<5>  'LHXX'
!   97  85    U1_C1.57   QSFP_LPMODE<4>  'LHXX'
!  123 111    U1_C1.74   QSFP_LPMODE<7>  'LHXX'
!  143 131    U1_C1.86   QSFP_LPMODE<8>  'LHXX'
!  147 135    U1_C1.92   QSFP_LPMODE<9>  'LHXX'
!  163 151    U1_C1.100  QSFP_LPMODE<10> 'LHXX'
!  187 175    U1_C1.117  QSFP_LPMODE<11> 'LHXX'
!  203 191    U1_C1.128  QSFP_LPMODE<12> 'LHXX'
!  211 199    U1_C1.139  QSFP_LPMODE<13> 'LHXX'

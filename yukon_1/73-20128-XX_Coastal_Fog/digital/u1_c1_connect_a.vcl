...
! ITL Test Source File:      digital/u1_c1_connect_a
! Test Name:                 U1_C1
! VCL created for chain:     U1_C1_U5_R3
! Date: Thu Sep 30 16:31:41 2021
...
assign N0002 to nodes "CPLD_INIT_N_PU_C1" ! Pin(s) 110
assign N0003 to nodes "CPLD_JTAGEN_C1" ! Pin(s) 120
assign N0004 to nodes "FPGA_CPLD1_RST_L" ! Pin(s) 56
assign N0005 to nodes "FPGA_CPLD1_SPI_CS_L" ! Pin(s) 70
assign N0006 to nodes "FPGA_CPLD1_SPI_MOSI" ! Pin(s) 71
assign N0007 to nodes "FPGA_CPLD1_SPI_SCK" ! Pin(s) 44
assign N0008 to nodes "FPGA_CPLD1_STROBE" ! Pin(s) 69
...
"11ZX1"!Test-Logic-Reset
"01ZX1"
"11ZX1"!Test-Logic-Reset Vector 2800
end pcf
end unit ! Connect Test Vector 2800
! Vectors with TDI High:    1952,   1.9 milliseconds
! Vectors with TDI Low:       88,  88.0 microseconds
! Total Vectors :           2800,   2.8 milliseconds

! Connect Test Dictionary
! Frame Size 220
! FrCell DevCell Dev.Pin Node             Signature
!   77  65    U1_C1.44   FPGA_CPLD1_SPI_SCK'LH'
!   79  67    U1_C1.45   CPLD1_FPGA_SPI_MISO'LH'
!   95  83    U1_C1.56   FPGA_CPLD1_RST_L'LH'
!  105  93    U1_C1.61   CPLD1_FPGA_DATA 'LH'
!  115 103    U1_C1.69   FPGA_CPLD1_STROBE'LH'
!  117 105    U1_C1.70   FPGA_CPLD1_SPI_CS_L'LH'
!  119 107    U1_C1.71   FPGA_CPLD1_SPI_MOSI'LH'
!  175 163    U1_C1.110  CPLD_INIT_N_PU_C1'LH'
!  191 179    U1_C1.120  CPLD_JTAGEN_C1  'LH'

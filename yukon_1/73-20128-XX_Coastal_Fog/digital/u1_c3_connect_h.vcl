...
! ITL Test Source File:      digital/u1_c3_connect_h
! Test Name:                 U1_C3
! VCL created for chain:     U1_C1_U5_R3
! Date: Thu Sep 30 17:12:32 2021
...
assign N0000 to nodes "SFP_MOD_ABS_FPGA<0>" ! Pin(s) 128
assign N0001 to nodes "SFP_MOD_ABS_FPGA<1>" ! Pin(s) 132
assign N0002 to nodes "SFP_RX_LOS_FPGA<0>" ! Pin(s) 126
assign N0003 to nodes "SFP_RX_LOS_FPGA<1>" ! Pin(s) 138
assign N0004 to nodes "SFP_RX_LOS_FPGA<2>" ! Pin(s) 104
assign N0005 to nodes "SFP_TX_FAULT_FPGA<0>" ! Pin(s) 122
assign N0006 to nodes "SFP_TX_FAULT_FPGA<1>" ! Pin(s) 125
assign N0007 to nodes "SFP_TX_FAULT_FPGA<2>" ! Pin(s) 141
...
use pcf order Parallel
"00ZX100000000"
"10ZX100000000"!Shift-DR
"10ZX1Z0000000"!Disable drivers sequentially. 
"10ZX1ZZ000000"
"10ZX1ZZZ00000"
"10ZX1ZZZZ0000"
"10ZX1ZZZZZ000"
...
"01ZX1XXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan Vector 2325
...
use pcf order Parallel
"00ZX111111111"
"10ZX111111111"!Shift-DR
"10ZX1Z1111111"!Disable drivers sequentially. 
"10ZX1ZZ111111"
"10ZX1ZZZ11111"
"10ZX1ZZZZ1111"
"10ZX1ZZZZZ111"

...
! ITL Test Source File:      digital/u8_connect_c
! Test Name:                 U8
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:30:50 2020
...
assign N0000 to nodes "BMC_ARM_JTAG_CLK_OUT" ! Pin(s) C9
assign N0010 to nodes "BMC_EMMC_D0" ! Pin(s) B12
assign N0001 to nodes "BMC_EMMC_SD1CD" ! Pin(s) C11
assign N0002 to nodes "BMC_FPGA_INTR_BMC" ! Pin(s) B18
assign N0003 to nodes "BMC_NCSI_CRSDV" ! Pin(s) C5
assign N0004 to nodes "BMC_RXD3_R" ! Pin(s) B19
assign N0005 to nodes "BMC_SPI1_FPGA_CLK_R" ! Pin(s) C15
assign N0006 to nodes "BMC_SPI1_FPGA_CS_R" ! Pin(s) B15
assign N0011 to nodes "CLK_33M_LPC_BMC" ! Pin(s) C22
assign N0012 to nodes "CLK_XGE_BMC_RGMII2" ! Pin(s) C2
...
assign N0013 to nodes "SRT_BMC_BMCPHY_MDIO2" ! Pin(s) B13
assign N0007 to nodes "SRT_BMC_MB_SCL" ! Pin(s) C14
assign N0014 to nodes "SRT_CLK_BMC_BMCPHY_MDC2" ! Pin(s) C13
assign N0008 to nodes "SRT_EMMC_CLK" ! Pin(s) C12
assign N0009 to nodes "UNNAMED_4189_AST2520_I1_GPIOD7SD2WPM" ! Pin(s) C21
assign N0015 to nodes "XGE_BMC_RGMII2_CTL" ! Pin(s) C1
assign N0016 to nodes "XGE_BMC_RGMII2_RXD0" ! Pin(s) C3
assign N0017 to nodes "XGE_BMC_RGMII2_RXD1" ! Pin(s) D1
...
bidirectional   N0000, N0010, N0001, N0002, N0003, N0004, N0005, N0006
bidirectional   N0011, N0012, N0013, N0007, N0014, N0008, N0009, N0015
bidirectional   N0016, N0017
...
use cards hybrid         on N0000, N0010, N0001, N0002, N0003, N0004, N0005, N0006
use cards hybrid         on N0011, N0012, N0013, N0007, N0014, N0008, N0009, N0015
use cards hybrid         on N0016, N0017
...
!LLLLLBBBBBBBSSUBCCSSXXX!
!JJJJJMMMMMMMRRNMLLRRGGG!
!TTTTTCCCCCCCTTNCKKTTEEE!
!AAAAA_________A________!
!GGGGGAEFNRSSBEME3XBCBBB!
!_____RMPCXPPMMEM3GMLMMM!
!TTTTTMMGSDIICMDMMECKCCC!
!CMDDR_CAI311_C_C_______!
!KSIOSJ______M_4_LBBBRRR!
!____TTSICRFFBC1DPMMMGGG!
!HHHH_ADNR PP_L80CCCCMMM!
!DDDDLG1TS GGSK9 __P_III!
!RRRR__CRD AAC _ BRHBIII!
!____HCD_V __L A MGYM222!
!3333DL B  CC  S CM_C___!
!VVVVRK M  LS  T  IMPCRR!
!3333__ C  K_  2  IDHTXX!
!____3O    _R  5  2IYLDD!
!MMMMVU    R   2   O_ 01!
!UUUU3T        0   2M   !
!XXXX          _    D   !
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXXX"!Shift-DR Vector 125
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXXX"!Run-Test/Idle Vector 450
"01ZX1XXXXXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
"01ZX1"
...
end unit ! Connect Test Vector 8715
! Vectors with TDI High:    3138,   3.1 milliseconds
! Vectors with TDI Low:      192, 192.0 microseconds
! Total Vectors :           8715,   8.7 milliseconds

! Connect Test Dictionary
! Frame Size 796
! FrCell DevCell Dev.Pin Node             Signature
!    4   2       U8.C9   BMC_ARM_JTAG_CLK_OUT'LHXX'
!   25  23       U8.C11  BMC_EMMC_SD1CD  'LHXX'
!   31  29       U8.C12  SRT_EMMC_CLK    'LHXX'
!   34  32       U8.B13  SRT_BMC_BMCPHY_MDIO2'LHXX'
!   37  35       U8.C13  SRT_CLK_BMC_BMCPHY_MDC2'LHXX'
!   43  41       U8.C14  SRT_BMC_MB_SCL  'LHXX'
!   52  50       U8.C15  BMC_SPI1_FPGA_CLK_R'LHXX'
!   55  53       U8.B15  BMC_SPI1_FPGA_CS_R'LHXX'
!   79  77       U8.B18  BMC_FPGA_INTR_BMC'LHXX'
!   95  93       U8.D1   XGE_BMC_RGMII2_RXD1'LHXX'
!   98  96       U8.C3   XGE_BMC_RGMII2_RXD0'LHXX'
!  101  99       U8.C1   XGE_BMC_RGMII2_CTL'LHXX'
!  104 102       U8.C2   CLK_XGE_BMC_RGMII2'LHXX'
!  173 171       U8.B12  BMC_EMMC_D0     'LHXX'
!  212 210       U8.B19  BMC_RXD3_R      'LHXX'
!  224 222       U8.C21  UNNAMED_4189_AST2520_I1_GPIOD7SD2WPM'LHXX'
!  257 255       U8.C22  CLK_33M_LPC_BMC 'LHXX'
!  772 770       U8.C5   BMC_NCSI_CRSDV  'LHXX'

...
! ITL Test Source File:      digital/u8_connect_j
! Test Name:                 U8
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:31:30 2020
...
! Boundary-Scan system pins tested: 6  (Not Including TAP Pins, Compliance
...
assign N0000 to nodes "HEARTBEAT_LED_ACTIVE_LOW" ! Pin(s) Y18
assign N0001 to nodes "I2C_BUS7_ALERT_R" ! Pin(s) Y21
assign N0002 to nodes "I2C_BUS9_ALERT_R" ! Pin(s) Y22
...
assign N0003 to nodes "MEM_DDR4_ACT_N" ! Pin(s) Y15
assign N0004 to nodes "MEM_DDR4_MA<9>" ! Pin(s) Y16
assign N0005 to nodes "SRT_BMC_SPI2_MUX_CLK" ! Pin(s) Y19
...
outputs         N0003, N0004
bidirectional   N0000, N0001, N0002, N0005
...
use cards hybrid         on N0000, N0001, N0002, N0003, N0004, N0005
...
pcf order Parallel is N0003, N0004, N0005
...
!Column-to-Node Map, Nodes 1 to 11
!LLLLLHIIMMS!
!JJJJJE22EER!
!TTTTTACCMMT!
!AAAAAR_____!
...
"01ZX0XXXXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
use pcf order Parallel
"00ZX1XXXXXX"
"10ZX1XXXXXX"!Shift-DR Vector 125
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
use pcf order Parallel
"00ZX1XXXXXX"
"10ZX1XXXXXX"!Run-Test/Idle Vector 450
"01ZX1XXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
"01ZX1"
...
use pcf order Parallel
"00ZX1000XX0"
"10ZX1000XX0"!Shift-DR
"10ZX1Z00XX0"!Disable drivers sequentially. 
"10ZX1ZZ0XX0"
"10ZX1ZZZXX0"
"10ZX1ZZZXXZ"
...
use pcf order Parallel
"00ZX1111XX1"
"10ZX1111XX1"!Shift-DR
"10ZX1Z11XX1"!Disable drivers sequentially. 
"10ZX1ZZ1XX1"! Vector 3850
"10ZX1ZZZXX1"
"10ZX1ZZZXXZ"
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
...
end unit ! Connect Test Vector 8687
! Vectors with TDI High:    3162,   3.1 milliseconds
! Vectors with TDI Low:      120, 120.0 microseconds
! Total Vectors :           8687,   8.6 milliseconds

! Connect Test Dictionary
! Frame Size 796
! FrCell DevCell Dev.Pin Node             Signature
!  336 334       U8.Y22  I2C_BUS9_ALERT_R'LHXX'
!  351 349       U8.Y21  I2C_BUS7_ALERT_R'LHXX'
!  390 388       U8.Y19  SRT_BMC_SPI2_MUX_CLK'LHXX'
!  399 397       U8.Y18  HEARTBEAT_LED_ACTIVE_LOW'LHXX'

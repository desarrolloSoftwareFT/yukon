...
! ITL Test Source File:      digital/u8_connect_b
! Test Name:                 U8
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:30:44 2020
...
assign N0000 to nodes "BMC_BMCFPGA_SDA" ! Pin(s) B9
assign N0001 to nodes "BMC_EMMC_SD11_WP" ! Pin(s) B11
assign N0002 to nodes "BMC_GPIOS7_STRAP" ! Pin(s) AA20
assign N0003 to nodes "BMC_NCSI_RCLKO_R" ! Pin(s) B5
assign N0009 to nodes "CLK50M_NCSI_BMC" ! Pin(s) B4
assign N0004 to nodes "I2C_BUS10_ALERT_R" ! Pin(s) AA22
...
assign N0005 to nodes "MEM_DDR4_CAS" ! Pin(s) AB13
assign N0007 to nodes "MEM_DDR4_MA<13>" ! Pin(s) AB15
assign N0006 to nodes "MEM_DDR4_MA<6>" ! Pin(s) AB16
assign N0008 to nodes "SPI_CS0_L_R" ! Pin(s) AB19
assign N0010 to nodes "SRT_BMC_XGE_RGMII2_CTL" ! Pin(s) B1
assign N0011 to nodes "SRT_BMC_XGE_RGMII2_TXD1" ! Pin(s) B3
assign N0012 to nodes "SRT_CLK_BMC_XGE_RGMII2" ! Pin(s) B2
...
outputs         N0005, N0007, N0006
bidirectional   N0000, N0001, N0002, N0003, N0009, N0004, N0008, N0010
bidirectional   N0011, N0012
...
use cards hybrid         on N0000, N0001, N0002, N0003, N0009, N0004, N0005, N0007
use cards hybrid         on N0006, N0008, N0010, N0011, N0012
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXX"!Shift-DR Vector 125
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXX"!Run-Test/Idle Vector 450
"01ZX1XXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
"01ZX1"
...
use pcf order Parallel
"00ZX100000XXX00000"
"10ZX100000XXX00000"!Shift-DR
"10ZX1Z0000XXX00000"!Disable drivers sequentially. 
"10ZX1ZZ000XXX00000"
"10ZX1ZZZ00XXX00000"
"10ZX1ZZZZ0XXX00000"
"10ZX1ZZZZZXXX00000"
...
"01ZX1XXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan Vector 3850
...
use pcf order Parallel
"00ZX111111XXX11111"
"10ZX111111XXX11111"!Shift-DR
"10ZX1Z1111XXX11111"!Disable drivers sequentially. 
"10ZX1ZZ111XXX11111"
"10ZX1ZZZ11XXX11111"
"10ZX1ZZZZ1XXX11111"
"10ZX1ZZZZZXXX11111"
...
use pcf order Parallel
"00ZX1ZZZZZXXXZZZZZ"
"10ZX1ZZZZZXXXZZZZZ"!Shift-DR Vector 5475
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
end unit ! Connect Test Vector 8699
! Vectors with TDI High:    3148,   3.1 milliseconds
! Vectors with TDI Low:      162, 162.0 microseconds
! Total Vectors :           8699,   8.6 milliseconds

! Connect Test Dictionary
! Frame Size 796
! FrCell DevCell Dev.Pin Node             Signature
!   10   8       U8.B9   BMC_BMCFPGA_SDA 'LHXX'
!   22  20       U8.B11  BMC_EMMC_SD11_WP'LHXX'
!  107 105       U8.B2   SRT_CLK_BMC_XGE_RGMII2'LHXX'
!  116 114       U8.B1   SRT_BMC_XGE_RGMII2_CTL'LHXX'
!  128 126       U8.B3   SRT_BMC_XGE_RGMII2_TXD1'LHXX'
!  333 331       U8.AA22 I2C_BUS10_ALERT_R'LHXX'
!  369 367       U8.AA20 BMC_GPIOS7_STRAP'LHXX'
!  396 394       U8.AB19 SPI_CS0_L_R     'LHXX'
!  781 779       U8.B4   CLK50M_NCSI_BMC 'LHXX'
!  787 785       U8.B5   BMC_NCSI_RCLKO_R'LHXX'

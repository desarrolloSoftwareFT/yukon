...
! ITL Test Source File:      digital/u8_connect_i
! Test Name:                 U8
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:31:25 2020
...
assign N0000 to nodes "BMC_FAN_INTR_R" ! Pin(s) W6
assign N0001 to nodes "BMC_GPIOS5_STRAP" ! Pin(s) W20
assign N0002 to nodes "CLK25M_BMC_CLKIN" ! Pin(s) W18
assign N0003 to nodes "GPIOZ5_VPOG7_NORA5" ! Pin(s) W22
assign N0004 to nodes "GPIOZ7_VPOG7_NORA7" ! Pin(s) W21
...
assign N0005 to nodes "MEM_DDR4_BG0" ! Pin(s) W13
assign N0006 to nodes "MEM_DDR4_CKE" ! Pin(s) Y11
assign N0010 to nodes "MEM_DDR4_MA<12>" ! Pin(s) Y14
assign N0007 to nodes "MEM_DDR4_MA<2>" ! Pin(s) W14
assign N0008 to nodes "MEM_DDR4_MA<4>" ! Pin(s) W15
assign N0009 to nodes "MEM_DDR4_MA<8>" ! Pin(s) W16
assign N0011 to nodes "MEM_DDR4_RAS" ! Pin(s) W12
assign N0012 to nodes "MEM_DDR4_WE" ! Pin(s) Y12
assign N0013 to nodes "SRT_BMC_SPI2_MUX_MOSI" ! Pin(s) W19
...
inputs          N0002
outputs         N0005, N0006, N0010, N0007, N0008, N0009, N0011, N0012
bidirectional   N0000, N0001, N0003, N0004, N0013
...
use cards hybrid         on N0000, N0001, N0002, N0003, N0004, N0005, N0006, N0010
use cards hybrid         on N0007, N0008, N0009, N0011, N0012, N0013
...
"01ZX0XXZXXXXXXXXXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
use pcf order Parallel
"00ZX1XXZXXXXXXXXXXX"
"10ZX1XXZXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXZXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
use pcf order Parallel
...
use pcf order Parallel
"00ZX1XXZXXXXXXXXXXX"
"10ZX1XXZXXXXXXXXXXX"!Shift-DR Vector 125
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
use pcf order Parallel
"00ZX1XXZXXXXXXXXXXX"
"10ZX1XXZXXXXXXXXXXX"!Run-Test/Idle Vector 450
"01ZX1XXZXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
"01ZX1"
...
use pcf order Parallel
"00ZX100000XXXXXXXX0"
"10ZX100000XXXXXXXX0"!Shift-DR
"10ZX1Z0000XXXXXXXX0"!Disable drivers sequentially. 
"10ZX1ZZ000XXXXXXXX0"
"10ZX1ZZZ00XXXXXXXX0"
"10ZX1ZZZZ0XXXXXXXX0"
"10ZX1ZZZZZXXXXXXXX0"
...
use pcf order Parallel
"00ZX111111XXXXXXXX1"
"10ZX111111XXXXXXXX1"!Shift-DR Vector 3850
"10ZX1Z1111XXXXXXXX1"!Disable drivers sequentially. 
"10ZX1ZZ111XXXXXXXX1"
"10ZX1ZZZ11XXXXXXXX1"
"10ZX1ZZZZ1XXXXXXXX1"
"10ZX1ZZZZZXXXXXXXX1"
...
use pcf order Parallel
"00ZX1XXZXXXXXXXXXXX"! Vector 7075
use pcf order Scan
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1ZZZZZLLLLLLLLZ"
"10ZX1ZZZZZLLLLLLLLZ"!Shift-DR
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
end unit ! Connect Test Vector 8691
! Vectors with TDI High:    3148,   3.1 milliseconds
! Vectors with TDI Low:      162, 162.0 microseconds
! Total Vectors :           8691,   8.6 milliseconds

! Connect Test Dictionary
! Frame Size 796
! FrCell DevCell Dev.Pin Node             Signature
!  342 340       U8.W22  GPIOZ5_VPOG7_NORA5'LHXX'
!  354 352       U8.W21  GPIOZ7_VPOG7_NORA7'LHXX'
!  375 373       U8.W20  BMC_GPIOS5_STRAP'LHXX'
!  387 385       U8.W19  SRT_BMC_SPI2_MUX_MOSI'LHXX'
!  477 475       U8.W18  CLK25M_BMC_CLKIN'LHXX'
!  598 596       U8.W6   BMC_FAN_INTR_R  'LHXX'

...
! ITL Test Source File:      digital/u8_connect_f
! Test Name:                 U8
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:31:08 2020
...
! Boundary-Scan system pins tested: 17  (Not Including TAP Pins, Compliance
...
assign N0000 to nodes "BMC_CPU_FPGA_SDA" ! Pin(s) N2
assign N0002 to nodes "BMC_I210_RESET_L_R" ! Pin(s) P22
assign N0001 to nodes "BMC_I2C1_SDA" ! Pin(s) P20
assign N0003 to nodes "BMC_ID_ACCESS_3" ! Pin(s) L18
assign N0004 to nodes "BMC_ID_ACCESS_6" ! Pin(s) N18
assign N0005 to nodes "BMC_ID_ACCESS_7" ! Pin(s) P19
assign N0006 to nodes "CHASSIS_IDPROM_SDA" ! Pin(s) M19
assign N0007 to nodes "I2C_BUS6_ALERT_R" ! Pin(s) P18
assign N0008 to nodes "IO_TYPE" ! Pin(s) P21
...
assign N0010 to nodes "SML0CLK_BMC" ! Pin(s) P2
assign N0009 to nodes "SML0_DATA_BMC_R" ! Pin(s) R1
assign N0011 to nodes "SRT_SM1_CLK_BMC" ! Pin(s) N21
assign N0012 to nodes "SRT_SML1_DATA_BMC" ! Pin(s) N22
assign N0013 to nodes "SRT_VR_SMB_CLK" ! Pin(s) N1
assign N0014 to nodes "SRT_X86_BMCFPGA_SCL" ! Pin(s) L3
assign N0015 to nodes "VR_SMB_DAT" ! Pin(s) P1
assign N0016 to nodes "X86_BMCFPGA_SDA" ! Pin(s) L4
...
bidirectional   N0000, N0002, N0001, N0003, N0004, N0005, N0006, N0007
bidirectional   N0008, N0010, N0009, N0011, N0012, N0013, N0014, N0015
bidirectional   N0016
...
use cards hybrid         on N0000, N0002, N0001, N0003, N0004, N0005, N0006, N0007
use cards hybrid         on N0008, N0010, N0009, N0011, N0012, N0013, N0014, N0015
use cards hybrid         on N0016
...
pcf order Parallel is N0011, N0012, N0013, N0014, N0015, N0016
...
!Column-to-Node Map, Nodes 1 to 22
!LLLLLBBBBBBCIISSSSSSVX!
!JJJJJMMMMMMH2OMMRRRRR8!
!TTTTTCCCCCCAC_LLTTTT_6!
!AAAAA______S_T00____S_!
!GGGGGCIIIIISBY_CSSVXMB!
!_____P22DDDIUPDLMMR8BM!
!TTTTTUC1___SSEAK1L_6_C!
!CMDDR_10AAA_6 T__1S_DF!
!KSIOSF__CCCI_ ABC_MBAP!
!____TPSRCCCDA _MLDBMTG!
!HHHH_GDEEEEPL BCKA_C A!
!DDDDLAASSSSRE M _TCF _!
!RRRR__ ESSSOR C BALP S!
!____HS T___MT _ M_KG D!
!3333DD _367__ R CB A A!
!VVVVRA L   SR    M _  !
!3333_  _   D     C S  !
!____3  R   A       C  !
!MMMMV              L  !
...
"01ZX0XXXXXXXXXXXXXXXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
use pcf order Parallel
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXX"!Shift-DR Vector 125
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXX"!Run-Test/Idle Vector 450
"01ZX1XXXXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
"01ZX1"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXX"!Shift-DR
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX100000000000000000"
"10ZX100000000000000000"!Shift-DR
"10ZX1Z0000000000000000"!Disable drivers sequentially. 
"10ZX1ZZ000000000000000"
"10ZX1ZZZ00000000000000"
"10ZX1ZZZZ0000000000000"
"10ZX1ZZZZZ000000000000"
"10ZX1ZZZZZZ00000000000"
"10ZX1ZZZZZZZ0000000000"
"10ZX1ZZZZZZZZ000000000"
"10ZX1ZZZZZZZZZ00000000"
"10ZX1ZZZZZZZZZZ0000000"
"10ZX1ZZZZZZZZZZZ000000"
"10ZX1ZZZZZZZZZZZZ00000"
"10ZX1ZZZZZZZZZZZZZ0000"
"10ZX1ZZZZZZZZZZZZZZ000"
"10ZX1ZZZZZZZZZZZZZZZ00"
"10ZX1ZZZZZZZZZZZZZZZZ0"
"10ZX1ZZZZZZZZZZZZZZZZZ"! Vector 2250
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX111111111111111111"
"10ZX111111111111111111"!Shift-DR
"10ZX1Z1111111111111111"!Disable drivers sequentially. 
"10ZX1ZZ111111111111111"
"10ZX1ZZZ11111111111111"
"10ZX1ZZZZ1111111111111"
"10ZX1ZZZZZ111111111111"
"10ZX1ZZZZZZ11111111111"
"10ZX1ZZZZZZZ1111111111"
"10ZX1ZZZZZZZZ111111111"
"10ZX1ZZZZZZZZZ11111111"
"10ZX1ZZZZZZZZZZ1111111"
"10ZX1ZZZZZZZZZZZ111111"
"10ZX1ZZZZZZZZZZZZ11111"
"10ZX1ZZZZZZZZZZZZZ1111"
"10ZX1ZZZZZZZZZZZZZZ111"! Vector 3875
"10ZX1ZZZZZZZZZZZZZZZ11"
"10ZX1ZZZZZZZZZZZZZZZZ1"
"10ZX1ZZZZZZZZZZZZZZZZZ"
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1ZZZZZZZZZZZZZZZZZ"
"10ZX1ZZZZZZZZZZZZZZZZZ"!Shift-DR
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
use pcf order Parallel
"00ZX1ZZZZZZZZZZZZZZZZZ"
"10ZX1ZZZZZZZZZZZZZZZZZ"!Shift-DR Vector 7100
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
! Vectors with TDI High:    3140,   3.1 milliseconds
...
!  297 295       U8.N21  SRT_SM1_CLK_BMC 'LHXX'
!  300 298       U8.N22  SRT_SML1_DATA_BMC'LHXX'
!  303 301       U8.P20  BMC_I2C1_SDA    'LHXX'
!  306 304       U8.P21  IO_TYPE         'LHXX'
!  309 307       U8.P22  BMC_I210_RESET_L_R'LHXX'
!  433 431       U8.L18  BMC_ID_ACCESS_3 'LHXX'
!  442 440       U8.M19  CHASSIS_IDPROM_SDA'LHXX'
!  451 449       U8.P19  BMC_ID_ACCESS_7 'LHXX'
!  454 452       U8.N18  BMC_ID_ACCESS_6 'LHXX'
!  460 458       U8.P18  I2C_BUS6_ALERT_R'LHXX'
!  703 701       U8.R1   SML0_DATA_BMC_R 'LHXX'
!  706 704       U8.P2   SML0CLK_BMC     'LHXX'
!  709 707       U8.P1   VR_SMB_DAT      'LHXX'
!  712 710       U8.N1   SRT_VR_SMB_CLK  'LHXX'
!  715 713       U8.N2   BMC_CPU_FPGA_SDA'LHXX'
!  760 758       U8.L4   X86_BMCFPGA_SDA 'LHXX'
!  763 761       U8.L3   SRT_X86_BMCFPGA_SCL'LHXX'

...
! ITL Test Source File:      digital/u1_connect_c
! Test Name:                 U1
! VCL created for chain:     U1_C_U1
! Date: Sun Sep 20 19:28:40 2020
...
assign N0000 to nodes "BMC_I2C_RST_L_2V5" ! Pin(s) J4
assign N0001 to nodes "BMC_SEC_BOOT_JTAG_TMS" ! Pin(s) L7
assign N0002 to nodes "CPU_1588_SYNC" ! Pin(s) K11
assign N0003 to nodes "CPU_1588_SYNC_MB" ! Pin(s) K3
assign N0004 to nodes "CPU_SEC_BOOT_JTAG_TCK" ! Pin(s) M9
assign N0005 to nodes "CPU_SEC_BOOT_JTAG_TDI" ! Pin(s) L10
assign N0006 to nodes "FM_CPU2PCH_THROT" ! Pin(s) M14
assign N0007 to nodes "FPGA_BMC_LPC_RST_2V5" ! Pin(s) K6
assign N0008 to nodes "JTAG_BMC_TDO_R" ! Pin(s) M7
assign N0009 to nodes "JTAG_TDI_3V3_I210" ! Pin(s) M6
...
assign N0010 to nodes "LJTAG_TMS_HDR_3V3" ! Pin(s) M11
assign TMS  to nodes "LJTAG_TMS_HDR_3V3_MUX"
assign TRST to nodes "LJTAG_TRST_L_HDR_3V3"
assign N0011 to nodes "SRT_FPGA_BMC_UART5_RXD" ! Pin(s) J6
...
bidirectional   N0008, N0009, N0010, N0011
 
use cards hybrid         on N0000, N0001, N0002, N0003, N0004, N0005, N0006, N0007
use cards hybrid         on N0008, N0009, N0010, N0011
...
pcf order Parallel is N0011
 

!Column-to-Node Map, Nodes 1 to 17
!LLLLLBBCCCCFFJJLS!
!JJJJJMMPPPPMPTTJR!
!TTTTTCCUUUU_GAATT!
!AAAAA______CAGGA_!
...
"01ZX0XXXXXXXXXXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
use pcf order Parallel
"00ZX1XXXXXXXXXXXX"! Vector 50
use pcf order Scan
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1XXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXX"!Shift-DR
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
use pcf order Parallel
"00ZX1000000000000"
"10ZX1000000000000"!Shift-DR
"10ZX1Z00000000000"!Disable drivers sequentially. 
"10ZX1ZZ0000000000"
"10ZX1ZZZ000000000"
"10ZX1ZZZZ00000000"
"10ZX1ZZZZZ0000000"! Vector 1050
"10ZX1ZZZZZZ000000"
"10ZX1ZZZZZZZ00000"
"10ZX1ZZZZZZZZ0000"
"10ZX1ZZZZZZZZZ000"
...
use pcf order Parallel
"00ZX1111111111111"
"10ZX1111111111111"!Shift-DR
"10ZX1Z11111111111"!Disable drivers sequentially.  Vector 1925
"10ZX1ZZ1111111111"
"10ZX1ZZZ111111111"
"10ZX1ZZZZ11111111"
"10ZX1ZZZZZ1111111"
...
end unit ! Connect Test Vector 2805
! Vectors with TDI High:    1364, 682.0 microseconds
! Vectors with TDI Low:       40,  20.0 microseconds
! Total Vectors :           2805,   1.4 milliseconds

! Connect Test Dictionary
! Frame Size 424
! FrCell DevCell Dev.Pin Node             Signature
!   47  47       U1.J6   SRT_FPGA_BMC_UART5_RXD'LH'
!   63  63       U1.J4   BMC_I2C_RST_L_2V5'LH'
!   65  65       U1.K3   CPU_1588_SYNC_MB'LH'
!   71  71       U1.K6   FPGA_BMC_LPC_RST_2V5'LH'
!  135 135       U1.L7   BMC_SEC_BOOT_JTAG_TMS'LH'
!  141 141       U1.M7   JTAG_BMC_TDO_R  'LH'
!  149 149       U1.M6   JTAG_TDI_3V3_I210'LH'
!  173 173       U1.M9   CPU_SEC_BOOT_JTAG_TCK'LH'
!  175 175       U1.L10  CPU_SEC_BOOT_JTAG_TDI'LH'
!  183 183       U1.M11  LJTAG_TMS_HDR_3V3'LH'
!  231 231       U1.M14  FM_CPU2PCH_THROT'LH'
!  235 235       U1.K11  CPU_1588_SYNC   'LH'

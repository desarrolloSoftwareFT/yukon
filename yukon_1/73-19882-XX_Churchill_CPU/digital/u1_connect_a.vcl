...
! ITL Test Source File:      digital/u1_connect_a
! Test Name:                 U1
! VCL created for chain:     U1_C_U1
! Date: Fri Sep 25 23:20:49 2020
...
assign N0001 to nodes "10GPHY_RST_L" ! Pin(s) B11
assign N0000 to nodes "1GPHY_RST_L" ! Pin(s) B12
assign N0002 to nodes "BDXDE_CATERR_GTL_N" ! Pin(s) C1
assign N0003 to nodes "BMC_CPU_MEM_WP_L" ! Pin(s) D11
assign N0004 to nodes "BMC_I2C_RST_L" ! Pin(s) C11
assign N0005 to nodes "C33_PLTRST_PROC_N" ! Pin(s) A3
assign N0006 to nodes "CONSOLE_RXD_DBG_2V5" ! Pin(s) D1
assign N0007 to nodes "CPLD_DONE" ! Pin(s) C13
assign N0008 to nodes "CPLD_I2C_SDA" ! Pin(s) C9
assign N0009 to nodes "CPLD_INIT_M" ! Pin(s) A13
assign N0010 to nodes "CPLD_PROG_M" ! Pin(s) B10
assign N0011 to nodes "CPU_ADR_IN_3V" ! Pin(s) C12
assign N0012 to nodes "CPU_SEC_BOOT_JTAG_TRST" ! Pin(s) E1
assign N0013 to nodes "CPU_THERMTRIP_3V3_L" ! Pin(s) C5
assign N0014 to nodes "DRAM_PWR_OK_FPGA_R" ! Pin(s) B6
...
assign N0015 to nodes "PCH_CONSOLE_RXD" ! Pin(s) D8
assign N0016 to nodes "PCH_CONSOLE_RXD1" ! Pin(s) B7
assign N0017 to nodes "PCH_CONSOLE_TXD" ! Pin(s) C7
assign N0018 to nodes "R_BMC_UART5_RXD" ! Pin(s) A15
assign N0019 to nodes "R_BMC_UART5_TX" ! Pin(s) A14
assign N0020 to nodes "UNNAMED_90_LCMXO3LF1300_I55_PT20CJTAGENB" ! Pin(s) C10
...
bidirectional   N0001, N0000, N0002, N0003, N0004, N0005, N0006, N0007
bidirectional   N0008, N0009, N0010, N0011, N0012, N0013, N0014, N0015
bidirectional   N0016, N0017, N0018, N0019, N0020
 
use cards hybrid         on N0001, N0000, N0002, N0003, N0004, N0005, N0006, N0007
use cards hybrid         on N0008, N0009, N0010, N0011, N0012, N0013, N0014, N0015
use cards hybrid         on N0016, N0017, N0018, N0019, N0020
...
!LLLLL11BBBCCCCCCCCCDPPPRRU!
!JJJJJG0DMM3OPPPPPPPRCCC__N!
!TTTTTPGXCC3NLLLLUUUAHHHBBN!
!AAAAAHPD___SDDDD___M___MMA!
!GGGGGYHECIPO____AST_CCCCCM!
!______Y_P2LLDIIPDEHPOOO__E!
!TTTTTR_CUCTEO2NRRCEWNNNUUD!
!CMDDRSRA__R_NCIO__RRSSSAA_!
!KSIOSTSTMRSRE_TGIBM_OOORR9!
!____T_TEESTX S__NOTOLLLTT0!
!HHHH_L_RMT_D DMM_ORKEEE55_!
!DDDDL LR__P_ A  3TI______L!
!RRRR_  _WLRD    V_PFRRTRTC!
!____H  GP OB     J_PXXXXXM!
!3333D  T_ CG     T3GDDDD X!
!VVVVR  LL __     AVA 1   O!
!3333_  _  N2     G3_     3!
!____3  N   V     __R     L!
!MMMMV      5     TL      F!
...
"01ZX0XXXXXXXXXXXXXXXXXXXXX"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXXXXXX"! Vector 50
use pcf order Scan
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXXXXXX"!Shift-DR
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
pcf
use pcf order Parallel
"001H1XXXXXXXXXXXXXXXXXXXXX"!0+0
use pcf order Scan
"101X1"
end pcf
...
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXXXXXX"! Vector 150
"10ZX1XXXXXXXXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
...
pcf
use pcf order Parallel
"001X1XXXXXXXXXXXXXXXXXXXXX"!0+0
use pcf order Scan
"101X1"
"00ZX1"!1
"10ZX1"
...
"10ZX1ZZZZZ0000000000000000"! Vector 1050
...
pcf
use pcf order Parallel
"000X1XXXXXXXXXXXXXXXXXXXXX"!0+0
use pcf order Scan
"100X1"
"001X1"!1
"101X1"
...
use pcf order Scan
"11ZX1"!Update-DR
"10ZX1"!Suppress Ground Bounce Vector 1925
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXXXXXXXX"
...
"10ZX1ZZZZZZZZZZZZZZZZZ1111"! Vector 1950
...
end unit ! Connect Test Vector 2823
! Vectors with TDI High:    1364, 682.0 microseconds
! Vectors with TDI Low:       40,  20.0 microseconds
! Total Vectors :           2823,   1.4 milliseconds

! Connect Test Dictionary
! Frame Size 424
! FrCell DevCell Dev.Pin Node             Signature
!    3   3       U1.D1   CONSOLE_RXD_DBG_2V5'LH'
!   13  13       U1.C1   BDXDE_CATERR_GTL_N'LH'
!   17  17       U1.E1   CPU_SEC_BOOT_JTAG_TRST'LH'
!  321 321       U1.A15  R_BMC_UART5_RXD 'LH'
!  325 325       U1.C13  CPLD_DONE       'LH'
!  327 327       U1.A13  CPLD_INIT_M     'LH'
!  333 333       U1.B12  1GPHY_RST_L     'LH'
!  335 335       U1.C12  CPU_ADR_IN_3V   'LH'
!  337 337       U1.A14  R_BMC_UART5_TX  'LH'
!  343 343       U1.B11  10GPHY_RST_L    'LH'
!  345 345       U1.D11  BMC_CPU_MEM_WP_L'LH'
!  349 349       U1.C11  BMC_I2C_RST_L   'LH'
!  357 357       U1.B10  CPLD_PROG_M     'LH'
!  359 359       U1.C10  UNNAMED_90_LCMXO3LF1300_I55_PT20CJTAGENB'LH'
!  373 373       U1.C9   CPLD_I2C_SDA    'LH'
!  379 379       U1.D8   PCH_CONSOLE_RXD 'LH'
!  393 393       U1.C7   PCH_CONSOLE_TXD 'LH'
!  395 395       U1.B7   PCH_CONSOLE_RXD1'LH'
!  403 403       U1.A3   C33_PLTRST_PROC_N'LH'
!  405 405       U1.B6   DRAM_PWR_OK_FPGA_R'LH'
!  413 413       U1.C5   CPU_THERMTRIP_3V3_L'LH'

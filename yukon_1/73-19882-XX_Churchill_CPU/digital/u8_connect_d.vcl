...
! ITL Test Source File:      digital/u8_connect_d
! Test Name:                 U8
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:31:00 2020
...
assign N0009 to nodes "BMC_EMMC_D1" ! Pin(s) D9
assign N0010 to nodes "BMC_EMMC_D2" ! Pin(s) D10
assign N0011 to nodes "BMC_EMMC_D3" ! Pin(s) E12
assign N0012 to nodes "BMC_EMMC_D5" ! Pin(s) D20
assign N0013 to nodes "BMC_EMMC_D6" ! Pin(s) D21
assign N0000 to nodes "BMC_NCSI_RXD1" ! Pin(s) D6
assign N0001 to nodes "BMC_NCSI_TXEN_R" ! Pin(s) E9
assign N0002 to nodes "I2C_BUS1_ALERT_R" ! Pin(s) E17
assign N0003 to nodes "I2C_BUS2_ALERT_R" ! Pin(s) D16
assign N0004 to nodes "I2C_BUS3_ALERT_R" ! Pin(s) D15
assign N0005 to nodes "I2C_BUS4_ALERT_R" ! Pin(s) E14
...
assign N0006 to nodes "RGMII1TXD2_GPIOT4" ! Pin(s) E7
assign N0007 to nodes "RGMII1TXD3_GPIOT5" ! Pin(s) D7
assign N0016 to nodes "SRT_BMCPHY_MDC1" ! Pin(s) D8
assign N0017 to nodes "SRT_BMCPHY_MDIO1" ! Pin(s) E10
assign N0008 to nodes "SRT_BMC_LPC_LAD<2>" ! Pin(s) D22
assign N0014 to nodes "SRT_BMC_XGE_RGMII2_TXD2" ! Pin(s) D5
assign N0015 to nodes "SRT_BMC_XGE_RGMII2_TXD3" ! Pin(s) D4
assign N0018 to nodes "XGE_BMC_RGMII2_RXD2" ! Pin(s) D2
assign N0019 to nodes "XGE_BMC_RGMII2_RXD3" ! Pin(s) E6
...
bidirectional   N0009, N0010, N0011, N0012, N0013, N0000, N0001, N0002
bidirectional   N0003, N0004, N0005, N0006, N0007, N0016, N0017, N0008
bidirectional   N0014, N0015, N0018, N0019
...
use cards hybrid         on N0009, N0010, N0011, N0012, N0013, N0000, N0001, N0002
use cards hybrid         on N0003, N0004, N0005, N0006, N0007, N0016, N0017, N0008
use cards hybrid         on N0014, N0015, N0018, N0019
...
!LLLLLBBIIIIRRSBBBBBSSSSXX!
!JJJJJMM2222GGRMMMMMRRRRGG!
!TTTTTCCCCCCMMTCCCCCTTTTEE!
!AAAAA______II____________!
!GGGGGNNBBBBIIBEEEEEBBBBBB!
!_____CCUUUU11MMMMMMMMMMMM!
!TTTTTSSSSSSTTCMMMMMCCCCCC!
!CMDDRII1234XX_CCCCC__PP__!
!KSIOS______DDL_____XXHHRR!
!____TRTAAAA23PDDDDDGGYYGG!
!HHHH_XXLLLL__C12356EE__MM!
!DDDDLDEEEEEGG_     __MMII!
!RRRR_1NRRRRPPL     RRDDII!
!____H _TTTTIIA     GGCI22!
!3333D R____OOD     MM1O__!
!VVVVR  RRRRTT<     II 1RR!
!3333_      452     II  XX!
!____3        >     22  DD!
!MMMMV              __  23!
...
"10ZX100000000000000000000"!Shift-DR
...
"10ZX1ZZZZZZZZZZZZZZZZZ000"! Vector 2250
...
"10ZX1ZZZZZZZZZ11111111111"
"10ZX1ZZZZZZZZZZ1111111111"
"10ZX1ZZZZZZZZZZZ111111111"! Vector 3875
...
"10ZX1XXXXXXXXXXXXXXXXXXXX"!Run-Test/Idle Vector 7100
"01ZX1XXXXXXXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan

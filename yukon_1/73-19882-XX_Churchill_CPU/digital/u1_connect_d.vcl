...
! ITL Test Source File:      digital/u1_connect_d
! Test Name:                 U1
! VCL created for chain:     U1_C_U1
! Date: Sat Jun 17 20:27:52 2023
...
assign N0000 to nodes "BMC_SEC_BOOT_JTAG_TCK" ! Pin(s) N6
assign N0001 to nodes "BMC_SEC_BOOT_JTAG_TDI" ! Pin(s) N8
assign N0002 to nodes "BMC_SEC_BOOT_JTAG_TDO" ! Pin(s) P4
assign N0003 to nodes "CPU_PCH_HOT_1V_L" ! Pin(s) P16
assign N0004 to nodes "CPU_SEC_BOOT_JTAG_TMS" ! Pin(s) T9
assign N0005 to nodes "JTAG_BMC_TDI_R" ! Pin(s) P5
assign N0006 to nodes "JTAG_TDO_3V3_I210" ! Pin(s) P7
assign N0007 to nodes "LJTAG_TCK_HDR_3V3" ! Pin(s) R10
assign TCK  to nodes "LJTAG_TCK_HDR_3V3_MUX"
assign N0008 to nodes "LJTAG_TDI_HDR_3V3" ! Pin(s) N10
assign TDI  to nodes "LJTAG_TDI_HDR_3V3_MUX"
assign N0009 to nodes "LJTAG_TDO_HDR_3V3" ! Pin(s) T4
...
end unit ! Connect Test Vector 2801
! Vectors with TDI High:    1364, 682.0 microseconds
! Vectors with TDI Low:       40,  20.0 microseconds
! Total Vectors :           2801,   1.4 milliseconds

! Connect Test Dictionary
! Frame Size 424
! FrCell DevCell Dev.Pin Node             Signature
!  105 105       U1.P4   BMC_SEC_BOOT_JTAG_TDO'LH'
!  107 107       U1.T4   LJTAG_TDO_HDR_3V3'LH'
!  115 115       U1.P5   JTAG_BMC_TDI_R  'LH'
!  133 133       U1.N6   BMC_SEC_BOOT_JTAG_TCK'LH'
!  139 139       U1.P7   JTAG_TDO_3V3_I210'LH'
!  157 157       U1.N8   BMC_SEC_BOOT_JTAG_TDI'LH'
!  161 161       U1.T9   CPU_SEC_BOOT_JTAG_TMS'LH'
!  179 179       U1.R10  LJTAG_TCK_HDR_3V3'LH'
!  181 181       U1.N10  LJTAG_TDI_HDR_3V3'LH'
!  225 225       U1.P16  CPU_PCH_HOT_1V_L'LH'

...
! ITL Test Source File:      digital/u8_connect_g
! Test Name:                 U8
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:31:12 2020
...
assign N0014 to nodes "BMCPHY_RESET_L_R" ! Pin(s) R22
assign N0000 to nodes "BMC_GPIOS4_STRAP" ! Pin(s) R19
assign N0001 to nodes "BMC_ID_ACCESS_5" ! Pin(s) T20
assign N0002 to nodes "BMC_RXD2_R" ! Pin(s) T5
assign N0003 to nodes "BMC_TXD2_R" ! Pin(s) R5
assign N0004 to nodes "BMC_WDT1_RST_2V5" ! Pin(s) T22
assign N0005 to nodes "BMC_WDT2_RST_2V5" ! Pin(s) R20
assign N0006 to nodes "FW_SPI2_R" ! Pin(s) T19
assign N0010 to nodes "I210_INTR_R" ! Pin(s) R21
assign N0007 to nodes "I2C_BUS5_ALERT_R" ! Pin(s) R18
assign N0008 to nodes "I2C_MB_ALERT_R" ! Pin(s) R3
assign N0009 to nodes "I2C_MB_RST_L_R" ! Pin(s) T3
...
assign N0011 to nodes "MEM_DDR4_BA0" ! Pin(s) U12
assign N0012 to nodes "SPI_BOOT_MISO" ! Pin(s) T18
assign N0013 to nodes "SRT_BMC_SPI2_MUX_CS" ! Pin(s) T17
...
outputs         N0011
bidirectional   N0014, N0000, N0001, N0002, N0003, N0004, N0005, N0006
bidirectional   N0010, N0007, N0008, N0009, N0012, N0013
...
use cards hybrid         on N0014, N0000, N0001, N0002, N0003, N0004, N0005, N0006
use cards hybrid         on N0010, N0007, N0008, N0009, N0011, N0012, N0013
...
!LLLLLBBBBBBFIIIIMSSB!
!JJJJJMMMMMMW2222EPRM!
!TTTTTCCCCCC_CCC1MITC!
!AAAAA______S___0___P!
!GGGGGGIRTWWPBMM_DBBH!
!_____PDXXDDIUBBIDOMY!
!TTTTTI_DDTT2S__NROC_!
!CMDDROA2212_5ART4T_R!
!KSIOSSC____R_LSR__SE!
!____T4CRRRR AET_BMPS!
!HHHH__E  SS LR_RAIIE!
!DDDDLSS  TT ETL 0S2T!
!RRRR_TS  __ R__  O__!
!____HR_  22 TRR   ML!
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXX"!Shift-DR Vector 125
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1 has failed,"
message "  suspect device or these pins:"
...
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXX"!Run-Test/Idle Vector 450
"01ZX1XXXXXXXXXXXXXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
"01ZX1"
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX100000000000X000"
"10ZX100000000000X000"!Shift-DR
"10ZX1Z0000000000X000"!Disable drivers sequentially. 
"10ZX1ZZ000000000X000"
"10ZX1ZZZ00000000X000"
"10ZX1ZZZZ0000000X000"
"10ZX1ZZZZZ000000X000"
"10ZX1ZZZZZZ00000X000"
"10ZX1ZZZZZZZ0000X000"
"10ZX1ZZZZZZZZ000X000"
"10ZX1ZZZZZZZZZ00X000"
"10ZX1ZZZZZZZZZZ0X000"
"10ZX1ZZZZZZZZZZZX000"
"10ZX1ZZZZZZZZZZZXZ00"
"10ZX1ZZZZZZZZZZZXZZ0"
"10ZX1ZZZZZZZZZZZXZZZ"
...
use pcf order Scan
"11ZX1"!Update-DR
"10ZX1"!Suppress Ground Bounce Vector 3850
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXX"
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX111111111111X111"
"10ZX111111111111X111"!Shift-DR
"10ZX1Z1111111111X111"!Disable drivers sequentially. 
"10ZX1ZZ111111111X111"
"10ZX1ZZZ11111111X111"
"10ZX1ZZZZ1111111X111"
"10ZX1ZZZZZ111111X111"
"10ZX1ZZZZZZ11111X111"
"10ZX1ZZZZZZZ1111X111"
"10ZX1ZZZZZZZZ111X111"
"10ZX1ZZZZZZZZZ11X111"
"10ZX1ZZZZZZZZZZ1X111"
"10ZX1ZZZZZZZZZZZX111"
"10ZX1ZZZZZZZZZZZXZ11"
"10ZX1ZZZZZZZZZZZXZZ1"
"10ZX1ZZZZZZZZZZZXZZZ"
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
...
use pcf order Scan
"11ZX1"!Update-DR
"10ZX1"!Suppress Ground Bounce Vector 5475
use pcf order Parallel
"00ZX1XXXXXXXXXXXXXXX"
"10ZX1XXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXX"
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1ZZZZZZZZZZZXZZZ"
"10ZX1ZZZZZZZZZZZXZZZ"!Shift-DR
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
"10ZX1"!Capture-DR
use pcf order Parallel
"00ZX1ZZZZZZZZZZZLZZZ"
"10ZX1ZZZZZZZZZZZLZZZ"!Shift-DR
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
"10ZX1XXXXXXXXXXXXXXX"!Run-Test/Idle
"01ZX1XXXXXXXXXXXXXXX"! Vector 8700
use pcf order Scan
"11ZX1"!Select-DR-Scan
...
end unit ! Connect Test Vector 8707
! Vectors with TDI High:    3144,   3.1 milliseconds
! Vectors with TDI Low:      174, 174.0 microseconds
! Total Vectors :           8707,   8.7 milliseconds

! Connect Test Dictionary
! Frame Size 796
! FrCell DevCell Dev.Pin Node             Signature
!  312 310       U8.R21  I210_INTR_R     'LHXX'
!  315 313       U8.R22  BMCPHY_RESET_L_R'LHXX'
!  318 316       U8.R20  BMC_WDT2_RST_2V5'LHXX'
!  321 319       U8.T22  BMC_WDT1_RST_2V5'LHXX'
!  327 325       U8.T20  BMC_ID_ACCESS_5 'LHXX'
!  457 455       U8.R19  BMC_GPIOS4_STRAP'LHXX'
!  463 461       U8.R18  I2C_BUS5_ALERT_R'LHXX'
!  466 464       U8.T17  SRT_BMC_SPI2_MUX_CS'LHXX'
!  469 467       U8.T19  FW_SPI2_R       'LHXX'
!  472 470       U8.T18  SPI_BOOT_MISO   'LHXX'
!  691 689       U8.T3   I2C_MB_RST_L_R  'LHXX'
!  694 692       U8.R3   I2C_MB_ALERT_R  'LHXX'
!  733 731       U8.T5   BMC_RXD2_R      'LHXX'
!  736 734       U8.R5   BMC_TXD2_R      'LHXX'

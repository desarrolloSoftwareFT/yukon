...
! ITL Test Source File:      digital/u1_c_pch_connect_e
! Test Name:                 U1_C_PCH
! VCL created for chain:     U1_C_U1
! Date: Thu Jul 23 13:26:17 2020
...
assign N0000 to nodes "CLK_100M_CPU_REF_DN" ! Pin(s) U2
assign N0001 to nodes "CLK_100M_CPU_REF_DP" ! Pin(s) U4
assign N0002 to nodes "CLK_100M_CPU_REF_G2_N_C" ! Pin(s) W2
assign N0003 to nodes "CLK_100M_CPU_REF_G2_P_C" ! Pin(s) W4
...
assign N0004 to nodes "PD_REFCLK14IN_C" ! Pin(s) W9
...
inputs          N0004
outputs         N0000, N0001, N0002, N0003
...
"01ZX0XXXXZ"!Reset via TRST* and synchonizing sequence
use pcf order Scan
"11ZX0"
"01ZX1"
"11ZX1"
...
"00ZX1XXXX0"
"10ZX1XXXX0"!Shift-DR
"10ZX1XXXXZ"!Disable drivers sequentially. 
...
use pcf order Parallel
"00ZX1XXXXZ"
"10ZX1XXXXZ"!Shift-DR Vector 3200
! Load 4 Sentinel bits into chain registers.
! This shifts out the first 4 bits of capture data for U1.
end pcf
compress
...
end unit ! Connect Test Vector 4920
! Vectors with TDI High:    1072,   1.0 milliseconds
! Vectors with TDI Low:      154, 154.0 microseconds
! Total Vectors :           4920,   4.9 milliseconds

! Connect Test Dictionary
! Frame Size 420
! FrCell DevCell Dev.Pin Node             Signature
!  286 283 U1_C_PCH.W9   PD_REFCLK14IN_C 'LHXX'
